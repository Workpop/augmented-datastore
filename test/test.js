...
describe('Test Augmented Datastore', function () {
  ...
  describe('ADS with fragments', function () {
    ...
    it('creating ADS should succeed', function () {
      ads = createAugmentedDatastore(mockDatastore)
        .withFragment({
          id: 'status',
          ...
          buildFragment: async function (id) {
    ...
    it('ADS index should create a second document in destination datastore', async function () {
      await ads.index('app2');
    ...
    it('onMessage handler should trigger fragment update', async function () {
    ...
    it('onMessage handler should trigger fragment update - bind', async function () {
